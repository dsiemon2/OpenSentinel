...
> "Look up DNS for opensentinel.ai" or "Check email security for example.com"
...
- "Check if example.com has SPF and DKIM set up"
...
> "Check admin@example.com" or "Send email from info@ to bob@example.com"
