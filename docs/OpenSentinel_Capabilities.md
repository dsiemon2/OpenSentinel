...
| Tool Execution | 123+ tools including shell, browser, files, search |
...
| Desktop App | ✅ Active | System tray, global hotkeys (Ctrl+Shift+M chat, Ctrl+Shift+O OpenSentinel) |
...
│         Video, Image Analysis, File Generation (123+)          │
├─────────────────────────────────────────────────────────────────┤
