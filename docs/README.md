...
**Version 3.6.1** | [GitHub](https://github.com/dsiemon2/OpenSentinel) | [Website](https://opensentinel.ai) | [App](https://app.opensentinel.ai) | [MIT License](../LICENSE)

OpenSentinel is a self-hosted personal AI assistant powered by Claude. It supports 9 communication channels (Telegram, Discord, Slack, WhatsApp, Signal, iMessage, Zalo, Web, and REST API), 300+ features, 124 tools, and a full plugin/skill ecosystem. Built with Bun, TypeScript, Hono, and React, it runs entirely on your own infrastructure with PostgreSQL and Redis.
...
| Document | Description |
|----------|-------------|
| [Tools Reference](TOOLS.md) | All 124 tools: shell, files, web, vision, generation, agents, and more |
...
| Document | Description |
|----------|-------------|
| [Testing](TESTING.md) | Running the 6,400+ test suite, writing tests, and coverage |
