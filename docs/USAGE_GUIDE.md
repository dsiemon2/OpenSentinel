...
>
> **22 custom tools + 71 MCP tools = 121 tools | 4,617+ tests, all passing**
...
```
Show the last 5 emails in admin@example.com
```
...
```
Send an email from admin@example.com to bob@example.com
...
```
Search admin@example.com for emails from john@example.com
```
Filters by sender.
...
```
Reply to email UID 1234 in admin@example.com saying "Thanks, I'll review it tomorrow"
```
...
Description: Self-hosted AI assistant with 121 tools
...
```
Check domain info for example.com
```
