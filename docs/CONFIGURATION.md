...
This document provides a complete reference for all environment variables used by OpenSentinel v2.0.0. Configuration is managed through environment variables, validated at startup using Zod schemas defined in `src/config/env.ts`.
